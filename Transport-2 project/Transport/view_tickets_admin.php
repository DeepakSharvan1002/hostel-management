...
<div class="navigation">
    <nav class="navbar navbar-default navbar-static-top navigation" >
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#" style="color: black;">View Tickets</a></li>
            <li><a href="update_bus_search.php">Update Bus</a></li>
...
<div class="container" align="center"><br>
        <h3 class="form-head">View Tickets</h3>
...
<p id="result" align="center" class="letter-design" style="margin-top: 15px; font-size: 20px; color: brown;"></p>
    ...
    { 
        ...
        <td>$time</td>
        <td>$amount Rs</td>
        <td><a href='update.php?bus_name=$bus_name&bus_number=$bus_number&from_place=$from_place&to_place=$to_place&time=$time&amount=$amount' class='btn btn-success'>Select</a></td>
        </tr>";
    }
    ?>
</div>
